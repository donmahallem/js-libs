...
[![-----------------------------------------------------](https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/water.png)](#h1-aligncenterdonmahallemtslint-configh1)
...
<p align="center">
  <b>@donmahallem tslint config</b></br>
  <sub><sub>
</p>
...
```
npm install @donmahallem/tslint-config
```
