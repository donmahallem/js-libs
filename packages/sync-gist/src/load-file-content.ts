...
import { InputFile, InputFileContent } from "./types"

export const loadFileContent: (file: InputFile, cwd?: string) => Promise<InputFileContent> = async (file: InputFile, cwd?: string): Promise<InputFileContent> => {
