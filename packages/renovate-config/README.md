...
[![-----------------------------------------------------](https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/water.png)](#h1-aligncenterdonmahallemrenovate-configh1)

# ➤ <h1 align="center">@donmahallem/renovate-config</h1>
<p align="center">
...
<p align="center">
  <b>General renovate config</b></br>
  <sub><sub>
</p>
...
```
npm install @donmahallem/renovate-config
```
